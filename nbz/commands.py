...
# %% auto 0
__all__ = ['console', 'error_console', 'nbdev_bump_version', 'nbdev_new', 'bump_version', 'check', 'new']
...
def _delegates_sorted(to:FunctionType=None, # Delegatee
